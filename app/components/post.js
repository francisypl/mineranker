        ...
        return (
            <div className={css(styles.container)}>
                ...
                <div className={css(styles.footer)}>
                    <div>
                        <a href="javascript:void(0)" className={css(styles.vote)} onClick={() => (console.log('@todo - Implement upvote'))}>
                            <img className={css(styles.svg)} src={require('./../assets/upvote_active.svg')}/>
                            <span className={css(styles.voteText)}>{upvote}</span>
                        </a>
                        <a href="javascript:void(0)" className={css(styles.vote)} onClick={() => (console.log('@todo - Implement downvote'))}>
